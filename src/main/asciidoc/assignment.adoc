...
==== Aufgabe 11.2 -- Sortierung des Scoreboards nach Name
...
==== Aufgabe 11.3 -- Sortierung des Scoreboards nach Score
...
==== Aufgabe 11.4 -- Kombinieren mehrerer Comparatoren
...
==== Aufgabe 12 - Implementieren des Iterable Interfaces
